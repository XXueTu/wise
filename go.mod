...
require (
	...
	gitlab.trustbe.net/jewel/jewel-library-sdk v0.0.0-20250224110837-1dc85fa56bc1 // indirect
	gitlab.trustbe.net/middleware/gaia-mesh/client/golang v0.0.0-20250219111957-82b038f3649d // indirect
